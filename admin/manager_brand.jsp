...
<h3>QUẢN LÝ THƯƠNG HIỆU</h3>
                    ...
                    <a href="<%=Constants.LINK_ROOT%>/admin/insert_brand.jsp">Thêm thương hiệu</a>
                    <table class="data">
                        <tr class="data">
                        ...
                        <center>
                            <a href="<%=Constants.LINK_ROOT%>/admin/update_brand.jsp?command=update&brand_id=<%=brand.getBrandID()%>">Sửa</a>&nbsp;&nbsp; | &nbsp;&nbsp;
                                <a href="<%=Constants.LINK_ROOT%>/ManagerBrandServlet?command=delete&brand_id=<%=brand.getBrandID()%>">Xóa</a>
                        </center>
                        </td>
                        </tr>
                        <% } %>
