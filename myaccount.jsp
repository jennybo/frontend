...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
    ...
    long user_id = users.getUserID();
           ...
           ArrayList<Bill> listBillByUser = billGet.getListBillByIdUser(user_id);
	...
	<div class="container">
      ...
      <ul class="nav nav-pills" role="tablist">
        ...
        <li role="presentation"><a href="/LaptopShop/LogoutServlet"><i class="glyphicon glyphicon-log-out" ></i><a>Đăng Xuất</a></li>
      </ul>
      </div>
        <!--//nav-->
        ...
        <form action="<%=Constants.LINK_ROOT%>/UserServlet" method="POST">
