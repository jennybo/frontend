...
<link href='//fonts.googleapis.com/css?family=Lato:400,100,300,700,900' rel='stylesheet' type='text/css'>
 ...
 <table class="table animated wow fadeInLeft" data-wow-delay=".5s">
		  ...
		  <tr class="cross1">
			<td class="t-data">
				<a href="<%=Constants.LINK_ROOT%>/single.jsp?productID=<%=list.getValue().getProduct().getProductID()%>" class="at-in">
			...
			<td class="t-data"><div class="quantity"> 
								<div class="quantity-select">            
                                                                    <a href="<%=Constants.LINK_ROOT%>/CartServlet?command=sub&productID=<%=list.getValue().getProduct().getProductID()%>"><div class="entry value-minus">&nbsp;</div></a>
										<div class="entry value"><span class="span-1"><%=list.getValue().getQuantity()%></span></div>									
										
                                                                                <a href="<%=Constants.LINK_ROOT%>/CartServlet?command=plus&productID=<%=list.getValue().getProduct().getProductID()%>"><div class="entry value-plus active">&nbsp;</div></a>
								</div>
                        ...
                        <td class="t-data"><a href="<%=Constants.LINK_ROOT%>/CartServlet?command=remove&productID=<%=list.getValue().getProduct().getProductID()%>"><img src="<%=Constants.LINK_ROOT%>/images/circle.png" class="img-responsive " alt=""></a></td>
